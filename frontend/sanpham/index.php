...
$limit      = (isset($_GET['limit'])) ? $_GET['limit'] : 3; //Đặt giới hạn số record trên page
$page       = (isset($_GET['page'])) ? $_GET['page'] : 1; //Mặc định là trang 1
...
// Yêu cầu `Twig` vẽ giao diện được viết trong file `frontend/sanpham/index.html.twig`
// với dữ liệu truyền vào file giao diện được đặt tên là `ds_sanpham`

// echo $twig->render('frontend/sanpham/index.html.twig', ['ds_sanpham' => $data] );

echo $twig->render('frontend/sanpham/index.html.twig', [
