...
// require 'motor-shop/vendor/PHPMailer/src/Exception.php';
// require 'motor-shop/vendor/PHPMailer/src/PHPMailer.php';
// require 'motor-shop/vendor/PHPMailer/src/SMTP.php';
...
if(isset($_POST['btnDangKy'])) 
{
    ...
    mysqli_close($conn);
     ...
     try {
         ...
         <table>
             <tr>
                 <td><h1 style="color: red; font-size: 16px; text-align: center;">TRANG BÁN HÀNG motor-shop</h1>
             ...
             <tr>
                 <td>
                     ...
                     <a href="$siteUrl/motor-shop/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                 </td>
             </tr>
             <tr>
                 <td>
                     <ul>
                         <li>Xem chúng tôi qua <a href="https://facebook.com/duy.anh.5439087">Facebook</a></li>
                         <li>Xem chúng tôi qua <a href="https://twitter.com/duy.anh">Twitter</a></li>
                     </ul>
                 </td>
             </tr>
         </table>
