...
// 3. Nếu người dùng có bấm nút Thêm mới thì thực thi câu lệnh INSERT
if(isset($_POST['btnThemMoi'])) 
{
    ...
    if (isset($_FILES['hsp_tentaptin']))
    {
        ...
        if ($_FILES['hsp_tentaptin']['error'] > 0)
        {
            ...
            // Ví dụ: move file từ C:\xampp\tmp\php6091.tmp -> C:/xampp/htdocs/learning.nentang.vn/motor-shop/assets/uploads/hoahong.jpg
